...
export const chatMessageTileFactory = (messageTileType: MessageTileType): React.FC<IChatMessageTilePresenterProps> => {
    switch (messageTileType) {
        case MessageTileType.ChatApp:
            return (ChatAppMessageTile);
        case MessageTileType.Restream:
            return (RestreamChatMessageTile);
        case MessageTileType.Minimalist:
            return (MinimalistChatMessageTile);
        default:
